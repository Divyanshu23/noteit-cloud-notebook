...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        if (user.password === undefined) {
            ...
            unsamePasswordsRef.current.style.display = "block"
            setTimeout(() => {
                unsamePasswordsRef.current.style.display = "none"
            }, 1500);
        }
    }
            ...
            <div className="bg-grey-lighter flex flex-col mt-6">
                <div className="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
                    <div className="bg-white px-6 py-8 rounded shadow-md text-black w-full">
                        ...
                        <div className="hidden text-red-600 my-1" ref={unsamePasswordsRef}>
                            <div className="flex">
                        ...
                        <button
                            type="submit"
                            className="w-full text-center text-lg py-3 rounded bg-green-600 text-gray-200 hover:bg-green-800 hover:text-white focus:outline-none my-1" onClick={handleLogin}
                        >Login</button>
                    </div>
